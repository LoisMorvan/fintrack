...
const CategorySchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'categoryLines': LinkSchema(
      id: 2719984550368363457,
      name: r'categoryLines',
      target: r'CategoryLine',
      single: false,
      linkName: r'category',
    ),
    r'investmentLines': LinkSchema(
      id: 8666302248073968519,
      name: r'investmentLines',
      target: r'InvestmentLine',
      single: false,
      linkName: r'category',
    )
  },
...
Category _categoryDeserialize(
  ...
  final object = Category(
    ...
    type: _CategorytypeValueEnumMap[reader.readByteOrNull(offsets[1])] ??
...
List<IsarLinkBase<dynamic>> _categoryGetLinks(Category object) {
  return [object.categoryLines, object.investmentLines];
}

void _categoryAttach(IsarCollection<dynamic> col, Id id, Category object) {
  object.id = id;
  object.categoryLines
      .attach(col, col.isar.collection<CategoryLine>(), r'categoryLines', id);
  object.investmentLines.attach(
      col, col.isar.collection<InvestmentLine>(), r'investmentLines', id);
}
...
extension CategoryQueryLinks
    on QueryBuilder<Category, Category, QFilterCondition> {
  QueryBuilder<Category, Category, QAfterFilterCondition> categoryLines(
      FilterQuery<CategoryLine> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'categoryLines');
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      categoryLinesLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'categoryLines', length, true, length, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      categoryLinesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'categoryLines', 0, true, 0, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      categoryLinesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'categoryLines', 0, false, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      categoryLinesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'categoryLines', 0, true, length, include);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      categoryLinesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'categoryLines', length, include, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      categoryLinesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'categoryLines', lower, includeLower, upper, includeUpper);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> investmentLines(
      FilterQuery<InvestmentLine> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'investmentLines');
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      investmentLinesLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'investmentLines', length, true, length, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      investmentLinesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'investmentLines', 0, true, 0, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      investmentLinesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'investmentLines', 0, false, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      investmentLinesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'investmentLines', 0, true, length, include);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      investmentLinesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'investmentLines', length, include, 999999, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition>
      investmentLinesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'investmentLines', lower, includeLower, upper, includeUpper);
    });
  }
}
